...
import { registerRoundtableRoutes } from './src/ai/roundtable-routes.js'
...
// Roundtable — the real-time multiplayer AI relay (streams Claude into shared
// room state so every participant sees the answer animate in at once).
registerRoundtableRoutes(app, resolveAuth)
